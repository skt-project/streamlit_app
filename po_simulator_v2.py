...
with st.sidebar:
    ...
    __REJECTED_SKUS_2 = []
    _REGION_LIST_2 = []
    _STOP_PO_SKU_ALLOWED_REGION = {"G2G-390": ["CENTRAL JAVA 1", "CENTRAL JAVA 2", "CENTRAL JAVA 3", "NORTH CENTRAL JAVA", "SOUTH CENTRAL JAVA", "WEST JAVA", "JABODETABEK"],
                                  "G2G-391" :  ["CENTRAL JAVA 1", "CENTRAL JAVA 2", "CENTRAL JAVA 3", "NORTH CENTRAL JAVA", "SOUTH CENTRAL JAVA", "WEST JAVA", "JABODETABEK"] }
